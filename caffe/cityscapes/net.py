...
def fcn(split):
    ...
    pydata_params['source'] = os.path.join('eval_list', split+ '.txt')
    pydata_params['batch_size'] = 4

    #pydata_params['mean_value'] = (128.0,128.0,128.0)
    pydata_params['scale'] = (0.0078125,0.0078125,0.0078125)
    pydata_params['new_height'] = 720
    pydata_params['new_width'] = 1280
    if split == 'train':
